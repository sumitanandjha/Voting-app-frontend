...
//         "https://vote-app-backend-dh8ei3z4o-sumit-anands-projects.vercel.app//root/elections",
//         {
//           title,
//           description,
//           parties,
...
//           ).toISOString(), // Set to 10 minutes from now
//         }
//       );
...
//               Voting End Time (minutes from now)
//             </label>
//             <input
//               type="number"
//               value={votingEndTime}
...
const CreateElectionForm = ({ onClose, onSuccess }) => {
    ...
    const handleSubmit = async (event) => {
        event.preventDefault();
        try {
            const response = await axios.post('https://vote-app-backend.vercel.app/root/elections', {
                title,
                description,
                parties,
                status,
